...
public class CustomerControllerTest {
	...
	public void addCustomerTest() throws Exception {
		...
		mockMvc.perform(post("/customers").contentType(MediaType.APPLICATION_JSON).content(content)
				...
				//.andExpect(jsonPath("$.customerDateOfBirth",is(LocalDate.of(1996,12,24))))
...
//	@Test
//	public void TestInvalidFindById() throws Exception
//	{
//		mockMvc.perform(MockMvcRequestBuilders.get("/customers/124").accept(MediaType.APPLICATION_JSON))
//		.andExpect(MockMvcResultMatchers.status().is(200))
//		.andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage").exists())
//		.andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage").value("Customer does not exists"))
//		.andDo(print());
//	}
